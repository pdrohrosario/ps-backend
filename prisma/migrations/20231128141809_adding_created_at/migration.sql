...
INSERT INTO "new_Feedback" ("active", "child", "id", "parent_id", "question", "response", "teacher_id") SELECT "active", "child", "id", "parent_id", "question", "response", "teacher_id" FROM "Feedback";
DROP TABLE "Feedback";
